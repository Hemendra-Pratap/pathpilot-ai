...
export const ProductShowcaseSection: React.FC = () => {
  return (
    <section aria-labelledby="showcase-heading" className="py-16 sm:py-24 bg-[#FAFAFA] border-b border-zinc-200/80">
      <Container className="space-y-10 sm:space-y-14">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3.5 sm:space-y-4">
          ...
          <h2 id="showcase-heading" className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-zinc-950 leading-tight">
