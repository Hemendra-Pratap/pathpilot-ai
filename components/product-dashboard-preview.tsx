...
export const ProductDashboardPreview: React.FC = () => {
  ...
  return (
    <div className="w-full rounded-2xl border border-zinc-200 bg-white shadow-lg overflow-hidden">
      {/* Top Application Bar */}
      ...
      <div className="p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8 bg-[#FAFAFA]">
        {/* Header Summary Grid */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 sm:gap-6 items-stretch">
          {/* Target Role & Readiness Score Widget */}
          <div className="md:col-span-7 bg-white p-5 sm:p-6 rounded-xl border border-zinc-200 shadow-xs flex flex-col justify-between space-y-4">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div className="space-y-1">
                <span className="text-xs font-mono font-semibold uppercase tracking-wider text-zinc-500">
                  CAREER TARGET
                </span>
                <h3 className="text-xl sm:text-2xl font-bold text-zinc-950 tracking-tight flex items-center space-x-2">
              ...
              <div className="text-left sm:text-right">
                <span className="text-xs font-mono font-semibold text-zinc-500 uppercase block">
                  READINESS
                </span>
                <span className="text-3xl sm:text-4xl font-bold font-mono text-zinc-950">
                  78%
                </span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div
                ...
                className="h-2.5 w-full bg-zinc-100 rounded-full overflow-hidden p-0.5 border border-zinc-200"
              >
                <div className="h-full bg-emerald-600 rounded-full w-[78%] transition-all duration-500" />
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white p-5 rounded-xl border border-zinc-200 shadow-xs flex flex-col justify-between space-y-2">
              <span className="text-xs font-mono text-zinc-500 uppercase font-medium">
                STRONG SKILLS
              </span>
        ...
        {activeTab === "overview" && (
          ...
          >
            ...
            <div className="md:col-span-6 bg-white p-5 sm:p-6 rounded-xl border border-zinc-200 shadow-xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-zinc-100">
                <h4 className="text-sm font-bold text-zinc-950 flex items-center space-x-2">
              ...
              <ul className="space-y-2.5">
                <li className="flex flex-col sm:flex-row sm:items-center justify-between text-sm p-2.5 rounded-lg bg-zinc-50 border border-zinc-100 gap-1.5">
                ...
                <li className="flex flex-col sm:flex-row sm:items-center justify-between text-sm p-2.5 rounded-lg bg-zinc-50 border border-zinc-100 gap-1.5">
                  <span className="font-semibold text-zinc-900">Machine Learning</span>
                  <span className="font-mono text-xs font-bold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200 self-start sm:self-auto">
                    81% • Proficient
                  </span>
                </li>
                <li className="flex flex-col sm:flex-row sm:items-center justify-between text-sm p-2.5 rounded-lg bg-zinc-50 border border-zinc-100 gap-1.5">
                  <span className="font-semibold text-zinc-900">NLP</span>
                  <span className="font-mono text-xs font-bold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200 self-start sm:self-auto">
                    74% • Proficient
                  </span>
                </li>
            ...
            <div className="md:col-span-6 bg-white p-5 sm:p-6 rounded-xl border border-zinc-200 shadow-xs space-y-4">
              ...
              <ul className="space-y-2.5">
                <li className="flex flex-col sm:flex-row sm:items-center justify-between text-sm p-2.5 rounded-lg bg-amber-50/60 border border-amber-200/80 gap-1.5">
                  <span className="font-semibold text-zinc-900">MLOps</span>
                  <span className="font-mono text-xs font-bold text-amber-800 bg-amber-100 px-2 py-0.5 rounded border border-amber-300 self-start sm:self-auto">
                    43% • Priority Gap
                  </span>
                </li>
                <li className="flex flex-col sm:flex-row sm:items-center justify-between text-sm p-2.5 rounded-lg bg-zinc-50 border border-zinc-100 gap-1.5">
                  <span className="font-semibold text-zinc-900">Cloud Deployment</span>
                  <span className="font-mono text-xs font-bold text-zinc-700 bg-zinc-100 px-2 py-0.5 rounded self-start sm:self-auto">
                    55% • In Progress
                  </span>
                </li>
                <li className="flex flex-col sm:flex-row sm:items-center justify-between text-sm p-2.5 rounded-lg bg-zinc-50 border border-zinc-100 gap-1.5">
                  <span className="font-semibold text-zinc-900">System Design</span>
                  <span className="font-mono text-xs font-bold text-zinc-700 bg-zinc-100 px-2 py-0.5 rounded self-start sm:self-auto">
                    60% • In Progress
                  </span>
                </li>
        ...
        {activeTab === "gaps" && (
          <div
            ...
            className="bg-white p-5 sm:p-6 rounded-xl border border-zinc-200 shadow-xs space-y-4 transition-all duration-200"
          >
            <h4 className="text-base font-bold text-zinc-950">
              Detailed Skill Gap Analysis
            </h4>
            <div className="space-y-3 text-sm text-zinc-600">
              <div className="p-4 rounded-lg bg-zinc-50 border border-zinc-200/70 space-y-2">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between font-semibold text-zinc-900 gap-1">
                  <span>MLOps & Pipeline Automation (Highest Priority)</span>
                  <span className="text-amber-600 font-mono text-xs">43% Match</span>
                </div>
              ...
              <div className="p-4 rounded-lg bg-zinc-50 border border-zinc-200/70 space-y-2">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between font-semibold text-zinc-900 gap-1">
                  ...
                  <span className="text-zinc-700 font-mono text-xs">55% Match</span>
                </div>
                <p className="text-xs text-zinc-500 leading-relaxed">
        ...
        {activeTab === "project" && (
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-zinc-100">
              <h4 className="text-base font-bold text-zinc-950 flex items-center space-x-2">
                <Code2 className="w-5 h-5 text-emerald-600 shrink-0" aria-hidden="true" />
            ...
            <div className="space-y-2">
              <h5 className="text-base sm:text-lg font-bold text-zinc-900">
        ...
        <div className="bg-zinc-950 text-white p-5 sm:p-6 rounded-xl border border-zinc-800 shadow-md flex flex-col md:flex-row md:items-center justify-between gap-5">
          <div className="space-y-2">
